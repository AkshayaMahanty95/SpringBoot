...
import com.ojas.emp.exception.NotFoundException;
...
public class EmployeeServiceImpl implements EmployeeService {
	...
	// Method to delete details to database.Throws
	// NotFoundException when Employee id is not avalable in database.
	@Override
	public String deleteEmp(int empId) {
		if (!repo.existsById(empId)) {
			throw new NotFoundException("Emp Id is not found");
		} else {
			repo.deleteById(empId);
			return "Emp deleted successfully : "+ empId;
		}
